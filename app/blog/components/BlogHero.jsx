...
import { SparklesCore } from "@/components/ui/AceternitySparkles";

export function BlogHero() {
  return (
    <div className="h-[40rem] w-full dark:bg-black flex flex-col items-center justify-center overflow-hidden rounded-md">
      <h1 className="md:text-7xl text-3xl lg:text-9xl font-bold text-center dark:text-white text-neutral-900 relative z-20">
        My Blog
      </h1>
